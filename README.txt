...
Usage:
	...
	EXAMPLES:
		...
		E1:		Start Hermes protocol generation:
			...
			# Start the genetic algorithm / protocol generator
			> python hermes -f
		...
		E2:		Test the generated protocol:
			...
			> python hermes -c
			> python hermes -b -p ./PD_Creator/some_protocol.py
			> win_client.bat
...
OPTIONS:
	...
	-d [--parserdefectdensity]
		[REQUIRED OPTION]
		Path the the defect density file generated by the parser program
