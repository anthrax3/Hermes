'''
    ...
    Created: 2014-05-14 11:17:20.443000
'''
...
if s_block_start("body_block"):
    ...
    # Beginning of block: 0.182807876298
    if s_block_start("0.182807876298"):
        s_string("0.182807876298+assurance")
        ...
        s_static("<a ")
        s_static("alt=\"")
        s_string("body_block_div_a1_block")
        s_static("\" ")
        s_static("href=\"")
        s_checksum("body_block_div_a1_block", algorithm="sha1")
        s_static("\" ")
        s_static(">")
        s_static("</a>")
        # End <a> tag
        ...
        s_static("<a ")
        s_static("alt=\"")
        s_string("body_block_div_if1_a1")
        s_static("\" ")
        s_static("href=\"127.0.0.1/")
        s_string("body_block_div_if1_a1")
        s_static("\" ")
        ...
        s_static("<a ")
        s_static("alt=\"")
        s_string("body_block_div_app1_a1")
        s_static("\" ")
        s_static("href=\"127.0.0.1/")
        s_string("body_block_div_app1_a1")
        s_static("\" ")
        ...
        # Beginning of block: 0.742023833122
        if s_block_start("0.742023833122"):
            s_string("0.742023833122+assurance")
            ...
            if s_block_start("body_block_div_div_a1_block"):
                ...
                s_static("<a ")
                s_static("alt=\"")
                s_string("body_block_div_div_a1")
                s_static("\" ")
                s_static("href=\"127.0.0.1/")
                s_string("body_block_div_div_a1")
                s_static("\" ")
            ...
            s_static("<a ")
            s_static("alt=\"")
            s_string("body_block_div_div_a1_block")
            s_static("\" ")
            s_static("href=\"")
            s_checksum("body_block_div_div_a1_block", algorithm="sha1")
            s_static("\" ")
            s_static(">")
            s_static("</a>")
            # End <a> tag
            ...
            s_static("<a ")
            s_static("alt=\"")
            s_string("body_block_div_div_if1_a1")
            s_static("\" ")
            s_static("href=\"127.0.0.1/")
            s_string("body_block_div_div_if1_a1")
            s_static("\" ")
            ...
            s_static("<a ")
            s_static("alt=\"")
            s_string("body_block_div_div_app1_a1")
            s_static("\" ")
            s_static("href=\"127.0.0.1/")
            s_string("body_block_div_div_app1_a1")
            s_static("\" ")
            ...
            # Beginning of block: 0.4072339603
            if s_block_start("0.4072339603"):
                s_string("0.4072339603+assurance")
            ...
            s_static("<a ")
            s_static("alt=\"")
            s_string("0.4072339603")
            s_static("\" ")
            s_static("href=\"")
            s_checksum("0.4072339603", algorithm="sha1")
            s_static("\" ")
            s_static(">")
            s_static("</a>")
            # End <a> tag
        ...
        s_static("<a ")
        s_static("alt=\"")
        s_string("0.742023833122")
        s_static("\" ")
        s_static("href=\"")
        s_checksum("0.742023833122", algorithm="sha1")
        s_static("\" ")
        s_static(">")
        s_static("</a>")
        # End <a> tag
    ...
    s_static("<a ")
    s_static("alt=\"")
    s_string("0.182807876298")
    s_static("\" ")
    s_static("href=\"")
    s_checksum("0.182807876298", algorithm="sha1")
    s_static("\" ")
    s_static(">")
    s_static("</a>")
    # End <a> tag
